            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-100 text-gray-800">
                <div className="flex flex-col justify-between">
                    <div className="space-y-2">
                        ...
                        <div className="text-gray-600">Heb je al een account?</div>
                        <Link to={"/login"} className={"text-orange-500"}>Login hier</Link>
                    </div>
                </div>
                <form noValidate="" className="space-y-6">
                    ...
                    <button type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded  bg-orange-500 text-gray-50">Registreren</button>
                </form>
            </div>
        </div>
    )
